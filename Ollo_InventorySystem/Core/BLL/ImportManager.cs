...
namespace Ollo_InventorySystem.Core.BLL
{
    public class ImportManager
    {
        ...
        {
            string LongQueryString = "INSERT INTO LteRouter ( ItemCode, ItemDescription, Batch , Tag , Serial , Mac , Imei , CheckKey ) VALUES ";
